...
import { createTeacherVocabWord, deleteTeacherVocabWord, getTeacherVocabWords, type TeacherVocabWord } from '@/api/teacher';
import { Button, Input, Spinner, Textarea, surfaceClass } from '@/components/common';
