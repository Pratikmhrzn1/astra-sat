 ...
 * wrong, and the button that turns any slice of it into a real exam.
 *
 ...
 * practise button is what makes the list drain rather than just accumulate.
 *
 * Lifted out of the page unchanged when the DNA tab arrived, so it keeps its
 * own filters, queries and mutation — switching tabs is not meant to reset
