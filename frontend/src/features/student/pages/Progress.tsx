...
import { getAnalytics, startTopicExam } from '@/features/student/api/student.api';
...
export default function Progress() {
  ...
  if (isLoading) {
    return <div style={{ padding: '64px 48px', textAlign: 'center', color: 'rgba(11,11,14,0.35)', fontSize: 14 }}>Loading…</div>;
  }
  ...
  return (
    <div className="screen-fade" style={{ padding: isMobile ? '20px 16px 80px' : '36px 48px 64px', maxWidth: 900 }}>
      ...
      <p style={{ fontSize: isMobile ? 14 : 15, color: 'rgba(11,11,14,0.55)', margin: '0 0 24px', maxWidth: 620, lineHeight: 1.6 }}>
      ...
      {!hasAnything ? (
        <div style={{ background: '#fff', border: '1px solid #E7E4DE', borderRadius: 16, padding: '48px 24px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(11,11,14,0.45)', margin: '0 auto 18px', maxWidth: 400, lineHeight: 1.6 }}>
            Sit a practice set or a full mock and this fills in — a score trend, and accuracy for every topic you've answered.
          </p>
          <button
            onClick={() => navigate('/student/exams')}
            style={{ height: 40, padding: '0 20px', border: 'none', borderRadius: 9999, background: '#E2562B', color: '#fff', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' }}
