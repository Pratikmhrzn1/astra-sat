...
import { getExams } from '@/entities/exam';
import {
  TREND_COLORS, PageHeader, NoteCard, EmptyState, pillClass, surfaceClass, kickerClass, pageClass,
} from '@/shared/ui';
import { cn } from '@/shared/lib/utils';
import { LiveResultCard, getLiveExamResults, type LiveExamResult } from '@/features/live-exam';
import { useMobile } from '@/shared/hooks/useMobile';
import { NO_SCORE, SECTION_MAX, formatExamScore, scoreColor } from '@/entities/score';
