    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#FAF9F6', padding: 48 }}>
        <div style={{ textAlign: 'center', maxWidth: 360 }}>
          ...
          <Link to="/forgot-password" style={{ color: '#E2562B', fontWeight: 600, textDecoration: 'none' }}>Request a new link</Link>
        </div>
      </div>
    );
  }
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#FAF9F6', padding: isMobile ? '40px 24px' : 48 }}>
      <div style={{ width: '100%', maxWidth: 388 }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: isMobile ? 32 : 38, margin: '0 0 8px', letterSpacing: '-0.02em' }}>Choose a new password</h2>
          <p style={{ margin: 0, color: 'rgba(11,11,14,0.55)', fontSize: 15 }}>Must be at least 8 characters.</p>
        </div>
