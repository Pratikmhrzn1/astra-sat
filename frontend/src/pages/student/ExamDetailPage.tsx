...
import {
  ...
  confirmAnswer, sendChatMessage,
  type QuestionWithAnswer,
} from '@/api/student';
import { pageClass, surfaceClass } from '@/components/common';
import {
  ESTIMATED_LABEL, SECTION_MAX, TOTAL_MAX,
  formatExamScore, formatScore, scoreColor,
} from '@/lib/score';
import { cn } from '@/lib/utils';
import { NarrativePanel } from '@/sections/student/exam-detail/NarrativePanel';
import { ReviewItem, type AiPending, type AiResult } from '@/sections/student/exam-detail/ReviewItem';
import { TutorChat, type ChatMessage } from '@/sections/student/exam-detail/TutorChat';
